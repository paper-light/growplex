...
migrate((app) => {
  ...
  unmarshal({
    ...
    "deleteRule": "@request.auth.orgMembers.org ?= chat.project.org\n&&\n  chat.project.org.orgMembers_via_org.role = 'owner'\n&&\nstatus = 'preview'",
    "listRule": "@request.auth.orgMembers.org ?= chat.project.org\n  &&\n(\n  chat.project.org.orgMembers_via_org.role = 'owner'\n  ||\n  @request.auth.id ?= chat.integration.operators\n)",
    "updateRule": "@request.auth.orgMembers.org ?= chat.project.org\n  &&\n(\n  chat.project.org.orgMembers_via_org.role = 'owner'\n  ||\n  @request.auth.id ?= chat.integration.operators\n)",
    "viewRule": "@request.auth.orgMembers.org ?= chat.project.org\n  &&\n(\n  chat.project.org.orgMembers_via_org.role = 'owner'\n  ||\n  @request.auth.id ?= chat.integration.operators\n)"
  }, collection)
