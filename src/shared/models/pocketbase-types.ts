...
export type AgentsResponse<Texpand = unknown> = Required<AgentsRecord> &
  BaseSystemFields<Texpand>;
export type ChatsResponse<Ttheme = unknown, Texpand = unknown> = Required<
  ChatsRecord<Ttheme>
> &
  BaseSystemFields<Texpand>;
export type DocumentsResponse<
  Tmetadata = unknown,
  Texpand = unknown
> = Required<DocumentsRecord<Tmetadata>> & BaseSystemFields<Texpand>;
export type FeedbacksResponse<
  Tmetadata = unknown,
  Texpand = unknown
> = Required<FeedbacksRecord<Tmetadata>> & BaseSystemFields<Texpand>;
export type IntegrationsResponse<Texpand = unknown> =
  Required<IntegrationsRecord> & BaseSystemFields<Texpand>;
export type LeadsResponse<Tmetadata = unknown, Texpand = unknown> = Required<
  LeadsRecord<Tmetadata>
> &
  BaseSystemFields<Texpand>;
...
export type NotificationsResponse<
  Tpayload = unknown,
  Texpand = unknown
> = Required<NotificationsRecord<Tpayload>> & BaseSystemFields<Texpand>;
export type OrgMembersResponse<Texpand = unknown> = Required<OrgMembersRecord> &
  BaseSystemFields<Texpand>;
export type OrgsResponse<Texpand = unknown> = Required<OrgsRecord> &
  BaseSystemFields<Texpand>;
...
export type RoomsResponse<Texpand = unknown> = Required<RoomsRecord> &
  BaseSystemFields<Texpand>;
export type SourcesResponse<Tmetadata = unknown, Texpand = unknown> = Required<
  SourcesRecord<Tmetadata>
> &
  BaseSystemFields<Texpand>;
export type SubscriptionsResponse<
  TusagePayload = unknown,
  Texpand = unknown
> = Required<SubscriptionsRecord<TusagePayload>> & BaseSystemFields<Texpand>;
export type TicketsResponse<Tmetadata = unknown, Texpand = unknown> = Required<
  TicketsRecord<Tmetadata>
> &
  BaseSystemFields<Texpand>;
